...
\begin{abstract}
Mangels Verf\"ugbarkeit von multitplattformf\"ahigen Apps zur Verwaltung von Einkaufslisten, entstand die Idee eine solche App zu entwicklen. Um den Entwicklungsaufwand möglichst gering zu halten und nicht für jede Plattform separat eine App zu programmieren, entschieden wir uns für das Framework Phonegap. Dieses Paper besch\"aftigt sich mit der Konzeption und Entwicklung der App.   
\end{abstract}
